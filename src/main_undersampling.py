...
def run_sampling_technique(df_res, X, y, kf, classifier, resampler):
    ...
    DTC_SMOTE_Res=pd.concat([ml_model_df,resample_tech_df,f_sns_df,f_sns_std_df,f_pre_df,f_pre_std_df,f_f1_df,f_f1_std_df,f_spc_df,f_spc_std_df,f_gmn_df,f_gmn_std_df],axis = 1)
...
if __name__ == '__main__':
    ...
    for model in model_list:
        ...
        df.to_csv('resultsUndersampling_{}.csv'.format(model))
    df.to_csv('resultsUndersampling_all.csv')
